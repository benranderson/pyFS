...
class ModelDefinition:
    ...
    def create_geometry(self, number=0, type=0, name='', designation='',
                        ...
                        I_zz=0, I_yy=0, J=0, A_y=None, A_z=None, P_yy=None, P_zz=None,
                        G=None, S_1_y=None, S_1_z=None, S_2_y=None, S_2_z=None, S_3_y=None,
                        S_3_z=None, S_4_y=None, S_4_z=None, G_2=None,
